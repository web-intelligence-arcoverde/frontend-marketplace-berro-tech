    ...
    <div>
      ...
      <p>
        <span style={{color: 'rgb(68, 68, 68)'}}>
          ...
          berrotech.com.br respeitar a sua privacidade em relação a qualquer
          informação sua que possamos coletar no site
          <a href='https://berrotech.com.br/'> berrotech.com.br</a>, e outros
      ...
      <p>
        <span style={{color: 'rgb(68, 68, 68)'}}>
          ...
          informação que o berrotech.com.br oferece no site e com caráter
      ...
      <ul>
        ...
        <li>
          <span style={{color: 'rgb(68, 68, 68)'}}>
            ...
            (softwares) do berrotech.com.br, de seus fornecedores ou terceiros,
      ...
      <p>
        <span style={{color: 'rgb(68, 68, 68)'}}>
          Esta política é efetiva a partir de&nbsp;8 April 2023 15:08
        </span>
      </p>
    </div>
  );
